...
# BẢNG KẾ HOẠCH THỰC HIỆN TIỂU LUẬN CHUYÊN NGÀNH
...
| **12** | 02/11 – 08/11/2026 | • Xây dựng Phân hệ Quản trị viên (Admin Portal) & Đánh giá (Review):<br>  + Kiểm duyệt hồ sơ đăng ký của đại lý Vendor (Duyệt / Từ chối).<br>  + Kiểm duyệt nội dung tour đăng bán do Vendor khởi tạo trước khi công khai lên sàn (Admin không tự tạo tour).<br>  + Quản lý tài khoản người dùng & đối tác Vendor (Khóa / Mở tài khoản vi phạm, Blacklist).<br>  + Quản lý đơn hàng toàn sàn và quy trình đối soát chi trả hoa hồng (10% sàn – 90% Vendor).<br>  + Báo cáo Dashboard: Biểu đồ doanh thu toàn sàn, số lượng booking hoàn tất, theo dõi dòng tiền thanh toán.<br>• Xây dựng Phân hệ Đánh giá (Review): Khách hàng đánh giá sao và đăng kèm ảnh chụp thực tế sau khi hoàn thành chuyến đi. | Cả nhóm | • Phân hệ Quản trị Admin hoàn chỉnh phục vụ vận hành và kiểm duyệt sàn du lịch.<br>• Module Review minh bạch, uy tín cho khách hàng. | Đạt | |
