...
export const MOCK_TOURS: Tour[] = [
  ...
  {
    id: 11,
    tourCode: 'DEMO-VIETQR-5K',
    title: '[DEMO TEST] TOUR TRẢI NGHIỆM THỬ NGHIỆM THANH TOÁN VIETQR THỰC TẾ (5.000Đ)',
    description: 'Tour thử nghiệm quét mã VietQR chuyển khoản tiền thật (5.000đ) trực tiếp về tài khoản Agribank / MoMo. Phục vụ kiểm thử quy trình thanh toán trực tuyến và nhận vé điện tử E-Ticket QR Code ngay lập tức.',
    price: 5000,
    childPrice: 5000,
    durationDays: 1,
    durationNights: 0,
    ...
    totalReviews: 88,
    status: 'ACTIVE' as any,
    includedServices: '• Trải nghiệm thanh toán quét mã VietQR tự động\n• Nhận vé điện tử E-Ticket QR Code tức thì\n• Thử nghiệm quy trình check-in vé',
    excludedServices: '• Không áp dụng cho chuyến đi thực tế (Chỉ dành cho thử nghiệm thanh toán)',
    cancellationPolicy: '• Hỗ trợ hoàn tiền test trực tiếp',
    itineraryDetails: JSON.stringify([
