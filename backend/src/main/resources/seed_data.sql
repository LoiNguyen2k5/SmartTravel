...
(
  ...
  '[{"day":1,"title":"NGÀY 1: TP.HCM → BANGKOK → PATTAYA","hotel":"Khách sạn Mercure Pattaya Ocean Resort ★★★★","hotelRooms":"Phòng đôi Deluxe Ocean View / Phòng đơn (phụ thu)","meals":{"sang":"Tự túc tại sân bay","trua":"Không có","chieu":"Không có","toi":"Đặc sản Tom Yum Goong & Pad Thai"},"morning":"Bay từ Tân Sơn Nhất đến Suvarnabhumi Bangkok (~1.5h). Xe đón đoàn di chuyển về Pattaya.","afternoon":"Đến Pattaya, nhận phòng khách sạn. Tham quan Chợ nổi 4 miền Pattaya (Floating Market).","evening":"Ăn tối đặc sản Thái. Tự do khám phá phố đêm Walking Street Pattaya.","highlights":["Nhập cảnh Thái Lan","Chợ nổi 4 miền Pattaya","Tom Yum Goong & Pad Thai","Walking Street Pattaya"]},{"day":2,"title":"NGÀY 2: ĐẢO SAN HÔ CORAL – PHẬT BỐN MẶT NONG NUCH","hotel":"Khách sạn Mercure Pattaya Ocean Resort ★★★★","hotelRooms":"Phòng đôi Deluxe Ocean View / Phòng đơn","meals":{"sang":"Buffet tại khách sạn","trua":"Buffet hải sản tại đảo Coral","chieu":"Không có","toi":"Nhà hàng Nong Nooch Village"},"morning":"Ăn sáng buffet. Tàu cao tốc đưa đoàn ra Đảo San Hô Coral, tắm biển, tham gia trò chơi biển.","afternoon":"Tham quan Vườn hoa nhiệt đới Nong Nooch và chiêm bái Phật Bốn Mặt Pattaya.","evening":"Ăn tối tại Nong Nooch Village, xem biểu diễn múa Thái, Muay Thai và xiếc voi.","highlights":["Đảo Coral","Buffet hải sản","Vườn hoa Nong Nooch","Show múa Thái"]},{"day":3,"title":"NGÀY 3: PATTAYA → BANGKOK – BUFFET BAIYOKE SKY","hotel":"Khách sạn Grande Centre Point Ratchadamri Bangkok ★★★★★","hotelRooms":"Phòng đôi Deluxe / Phòng đơn","meals":{"sang":"Buffet tại khách sạn","trua":"Nhà hàng Mango Tree Bangkok","chieu":"Không có","toi":"Đại tiệc Buffet 86 tầng Baiyoke Sky"},"morning":"Ăn sáng buffet, trả phòng. Di chuyển về Bangkok (~1.5h). Mua sắm tại IconSiam bên bờ sông.","afternoon":"Ăn trưa, tham quan chợ Or Tor Kor và nhận phòng khách sạn 5 sao.","evening":"Đại tiệc buffet tầng 86 tòa nhà Baiyoke Sky Tower xoay 360 độ ngắm toàn cảnh Bangkok.","highlights":["IconSiam","Chợ Or Tor Kor","Buffet Baiyoke Sky 86 tầng"]},{"day":4,"title":"NGÀY 4: BANGKOK – CHÙA PHẬT VÀNG – DẠO THUYỀN CHAOPHRAYA","hotel":"Khách sạn Grande Centre Point Ratchadamri ★★★★★","hotelRooms":"Phòng đôi Deluxe / Phòng đơn","meals":{"sang":"Buffet tại khách sạn","trua":"Ẩm thực Hoàng gia Blue Elephant","chieu":"Không có","toi":"Chợ đêm Asiatique The Riverfront"},"morning":"Chiêm bái Chùa Wat Traimit (Chùa Phật Vàng 5 tấn) và viếng Tứ Diện Phật Erawan linh thiêng.","afternoon":"Dạo thuyền trên dòng sông Chaophraya huyền thoại, ngắm chùa Wat Arun.","evening":"Khám phá chợ đêm Asiatique The Riverfront, tự do ẩm thực và ngắm sông về đêm.","highlights":["Chùa Phật Vàng Wat Traimit","Tứ Diện Phật Erawan","Dạo thuyền Chaophraya","Asiatique The Riverfront"]},{"day":5,"title":"NGÀY 5: BANGKOK → TP.HCM","hotel":"","hotelRooms":"","meals":{"sang":"Buffet tại khách sạn","trua":"Tự túc tại sân bay","chieu":"Không có","toi":"Tự túc"},"morning":"Ăn sáng buffet, trả phòng. Tham quan trung tâm nghiên cứu rắn hoàng gia Siam Serpentarium.","afternoon":"Ra sân bay Suvarnabhumi, làm thủ tục xuất cảnh. Đáp chuyến bay về TP.HCM.","evening":"","highlights":["Trung tâm rắn Siam Serpentarium","Duty Free Suvarnabhumi"]}]'
),
(
