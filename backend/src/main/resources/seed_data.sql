...
-- 2. Insert Default Accounts (Password is BCrypt hash for "123456")
-- Hash: $2a$10$vTbdWXoPA0ZTkY8lPrL60.rqnjgBHgPWM9d/JN1xfsRkPrg.MqvUS -> "123456"
INSERT INTO users (id, created_at, updated_at, email, password, full_name, phone, avatar_url, enabled) VALUES 
(1, NOW(), NOW(), 'admin@smarttravel.com', '$2a$10$vTbdWXoPA0ZTkY8lPrL60.rqnjgBHgPWM9d/JN1xfsRkPrg.MqvUS', 'Quản Trị Viên Hệ Thống', '0901234567', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150', 1),
(2, NOW(), NOW(), 'vendor@smarttravel.com', '$2a$10$vTbdWXoPA0ZTkY8lPrL60.rqnjgBHgPWM9d/JN1xfsRkPrg.MqvUS', 'NewTour Travel Company', '0988776655', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150', 1),
(3, NOW(), NOW(), 'user@smarttravel.com', '$2a$10$vTbdWXoPA0ZTkY8lPrL60.rqnjgBHgPWM9d/JN1xfsRkPrg.MqvUS', 'Khách Hàng SmartTravel', '0912345678', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150', 1),
(4, NOW(), NOW(), 'customer@smarttravel.com', '$2a$10$vTbdWXoPA0ZTkY8lPrL60.rqnjgBHgPWM9d/JN1xfsRkPrg.MqvUS', 'Nguyễn Văn Khách', '0911223344', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150', 1)
